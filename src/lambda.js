...
var import_axios, import_dotenv;
var init_gpt = __esm({
  "dev/controllers/gpt.ts"() {
    "use strict";
...
var import_axios2, import_dotenv2;
var init_gpt2 = __esm({
  "dev/components/gpt.ts"() {
    "use strict";
...
var App, AwsLambdaReceiver, subtype, awsLambdaReceiver;
var init_slack = __esm({
  "dev/controllers/slack.ts"() {
    "use strict";
    init_gpt2();
    init_challenge();
    ({ App, AwsLambdaReceiver, subtype } = require("@slack/bolt"));
...
// dev/app.ts
var app_exports = {};
var import_fastify, import_dotenv3, fastifyOptions, app;
var init_app = __esm({
  "dev/app.ts"() {
    "use strict";
    import_fastify = __toESM(require("fastify"));
    import_dotenv3 = __toESM(require("dotenv"));
    init_router();
    import_dotenv3.default.config();
    fastifyOptions = {
      logger: true
    };
    app = (0, import_fastify.default)(fastifyOptions);
...
// dev/lambda.ts
var awsLambdaFastify = require("@fastify/aws-lambda");
var init = (init_app(), __toCommonJS(app_exports));
var proxy = awsLambdaFastify(init());
